...
public class BleLockDeviceActivity extends AppCompatActivity {
    private long siteId;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.config_ble_lock_activity);
            ...
            public void onSuccess(ScanDeviceBean result) {
                ...
                ThingOSLock.getBleLockActivator().startActivator(siteId, result, new IBleActivatorListener() {
                    ...
                    public void onSuccess(DeviceBean deviceBean) {
                        Toast.makeText(BleLockDeviceActivity.this, R.string.success, Toast.LENGTH_SHORT).show();
                        finish();
                    }

                    @Override
                    public void onFailure(int code, String msg, Object handle) {
                        Toast.makeText(BleLockDeviceActivity.this, R.string.failed, Toast.LENGTH_SHORT).show();
                    }
                });
            }
